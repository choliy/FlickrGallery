...
import net.wizapps.fgallery.adapter.GalleryAdapter;
import net.wizapps.fgallery.async.FetchPicturesTask;
...
import net.wizapps.fgallery.view.ItemDividerDecoration;
